...
<body>
    ...
    <nav>
        <div class="nav-inner">
            ...
            <div class="nav-links">
                ...
                <a href="/category/Electronics" @if($category === 'Electronics') class="active" @endif>Electronics</a>
                <a href="/category/Accessories" @if($category === 'Accessories') class="active" @endif>Accessories</a>
                <a href="/category/Office Supplies" @if($category === 'Office Supplies') class="active" @endif>Office Supplies</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>{{ $category }}</h1>
            <p>All products under the {{ $category }} category.</p>
        </div>

        <div class="stats">
            <div class="stat-card">
                <div class="label">Total in Category</div>
        ...
        <div class="card">
            <div class="card-header">{{ $category }} Records</div>
            <table>
                <thead>
                    <tr>
                        <th>#</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="empty">No products found in this category.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
